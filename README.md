...
Generate a fully typesafe fetch-based API client from an OpenAPI 3.x spec.
...
- **Edge cases handled** — `allOf`, `oneOf`, `anyOf`, enums, nullable, circular refs, `additionalProperties`
...
```bash
# From a local file
api-client-gen generate -i ./spec.yaml -o ./src/api

# From a URL
api-client-gen generate -i https://api.example.com/openapi.json -o ./src/api

# With a custom client class name
api-client-gen generate -i ./spec.yaml -o ./src/api --name MyApi
```
...
| `schemas.yml` | Edge cases: allOf, oneOf, anyOf, enums, nullable, circular refs |
